	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft"><a href="${pageContext.request.contextPath}/addContent.jsp">Add Blog</a></h2>
						...
						<div class="col-md-3 col-sm-6 col-padding animate-box" data-animate-effect="fadeInLeft">
							<div class="Blog-entry">
								...
								></small></span>
									...
									<a href="${pageContext.request.contextPath}/content/delete?contentId=${item.contentId}&currentPage=${requestScope.pageBean.currentPage}" >Delete </a>&nbsp;&nbsp;&nbsp;
									<a href="${pageContext.request.contextPath}/content/getOne?contentId=${item.contentId}&currentPage=${requestScope.pageBean.currentPage}&flag=2" class="lead">Read More </a>
								</div>
							</div>
						</div>
					</c:forEach>
				...
				<c:forEach begin="${requestScope.pageBean.currentPage-1}" end="${requestScope.pageBean.currentPage+3}" var="i">
					<a href="${pageContext.request.contextPath}/content/getUserAll?currentPage=${i}&pageSize=8">${i}</a>&nbsp;&nbsp;
				</c:forEach>
